...
- [x] 4.1 Реализация команд для тестирования ИИ сервисов
- [x] 4.2 Интеграция Fashn API
...
### AI/ML
- **Fashn API** - генерация try-on изображений
...
- [x] Создать команду /test_fashn
- [x] Реализовать заглушки для ответов от сервиса
- [x] Добавить клавиатуру с кнопкой выбора ИИ сервиса
- [x] Создать систему ожидания ответа от выбранного сервиса
- [x] Добавить логирование запросов для анализа качества

#### 4.2 Интеграция Fashn API
